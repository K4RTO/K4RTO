...
const translations: Record<string, TranslationEntry> = {
  ...
  "menu.calc.unit":            { en: "Unit Converter",            zh: "单位换算" },
  // Calendar
  ...
  "snake.hint":                { en: "Arrow keys / WASD · Space to pause",
                                 zh: "方向键 / WASD · 空格暂停" },
  "dock.tetris":               { en: "Tetris",                    zh: "俄罗斯方块" },
  "tetris.score":              { en: "Score",                     zh: "得分" },
  "tetris.best":               { en: "Best",                      zh: "最高" },
  "tetris.level":              { en: "Level",                     zh: "等级" },
  "tetris.lines":              { en: "Lines",                     zh: "消行" },
  "tetris.next":               { en: "Next",                      zh: "下一个" },
  "tetris.newGame":            { en: "New Game",                  zh: "新游戏" },
  "tetris.tryAgain":           { en: "Try Again",                 zh: "再来一次" },
  "tetris.gameOver":           { en: "Game Over",                 zh: "游戏结束" },
  "tetris.paused":             { en: "Paused",                    zh: "已暂停" },
  "tetris.pauseHint":          { en: "Press Space / P to resume", zh: "按 空格 / P 键继续" },
  "tetris.hint":               { en: "← → move · ↓ soft drop · ↑/X rotate · Z rotate ccw · Shift hard drop · Space pause",
                                 zh: "← → 移动 · ↓ 软降 · ↑/X 顺时针旋转 · Z 逆时针 · Shift 硬降 · 空格暂停" },
  ...
  "settings.wifi":             { en: "Wi-Fi",                     zh: "无线局域网" },
  ...
  "settings.accessibility":    { en: "Accessibility",             zh: "辅助功能" },
  "settings.siri":             { en: "Apple Intelligence & Siri", zh: "Apple 智能与 Siri" },
  "settings.menuBar":          { en: "Menu Bar",                  zh: "菜单栏" },
  "settings.spotlight":        { en: "Spotlight",                 zh: "聚焦" },
  "settings.focus":            { en: "Focus",                     zh: "专注模式" },
  ...
  "settings.softwareUpdate":   { en: "Software Update",           zh: "软件更新" },
  "settings.storage":          { en: "Storage",                   zh: "储存空间" },
  "settings.appleCare":        { en: "AppleCare & Warranty",      zh: "AppleCare 与保修" },
  "settings.airDrop":          { en: "AirDrop & Continuity",      zh: "隔空投送与接力" },
  "settings.passwords":        { en: "AutoFill & Passwords",      zh: "自动填充与密码" },
  "settings.dateTime":         { en: "Date & Time",               zh: "日期与时间" },
  "settings.language":         { en: "Language & Region",         zh: "语言与地区" },
  "settings.loginItems":       { en: "Login Items & Extensions",  zh: "登录项与扩展" },
  "settings.sharing":          { en: "Sharing",                   zh: "共享" },
  "settings.startupDisk":      { en: "Startup Disk",              zh: "启动磁盘" },
  "settings.timeMachine":      { en: "Time Machine",              zh: "时间机器" },
  "settings.deviceManagement": { en: "Device Management",         zh: "设备管理" },
  ...
  "calculator.mode.basic":     { en: "Basic",                     zh: "基础" },
  "calculator.mode.sci":       { en: "Scientific",                zh: "科学" },
  "calculator.mode.unit":      { en: "Unit converter",            zh: "单位换算" },
  "calculator.unit.cat.length":      { en: "Length",          zh: "长度" },
  "calculator.unit.cat.weight":      { en: "Weight",          zh: "重量" },
  "calculator.unit.cat.temperature": { en: "Temp",            zh: "温度" },
  "calculator.unit.cat.time":        { en: "Time",            zh: "时间" },
  "calculator.unit.from":      { en: "From",                      zh: "从" },
  "calculator.unit.to":        { en: "To",                        zh: "到" },
  "calculator.unit.swap":      { en: "Swap",                      zh: "交换" },
  "calculator.unit.u.length.m":  { en: "meters (m)",              zh: "米 (m)" },
  "calculator.unit.u.length.cm": { en: "centimeters (cm)",        zh: "厘米 (cm)" },
  "calculator.unit.u.length.mm": { en: "millimeters (mm)",        zh: "毫米 (mm)" },
  "calculator.unit.u.length.km": { en: "kilometers (km)",         zh: "千米 (km)" },
  "calculator.unit.u.length.in": { en: "inches (in)",             zh: "英寸 (in)" },
  "calculator.unit.u.length.ft": { en: "feet (ft)",               zh: "英尺 (ft)" },
  "calculator.unit.u.length.mi": { en: "miles (mi)",              zh: "英里 (mi)" },
  "calculator.unit.u.weight.kg": { en: "kilograms (kg)",          zh: "千克 (kg)" },
  "calculator.unit.u.weight.g":  { en: "grams (g)",               zh: "克 (g)" },
  "calculator.unit.u.weight.mg": { en: "milligrams (mg)",         zh: "毫克 (mg)" },
  "calculator.unit.u.weight.lb": { en: "pounds (lb)",             zh: "磅 (lb)" },
  "calculator.unit.u.weight.oz": { en: "ounces (oz)",             zh: "盎司 (oz)" },
  "calculator.unit.u.weight.t":  { en: "metric tons (t)",         zh: "吨 (t)" },
  "calculator.unit.u.temperature.C": { en: "Celsius (°C)",        zh: "摄氏度 (°C)" },
  "calculator.unit.u.temperature.F": { en: "Fahrenheit (°F)",     zh: "华氏度 (°F)" },
  "calculator.unit.u.temperature.K": { en: "Kelvin (K)",          zh: "开尔文 (K)" },
  "calculator.unit.u.time.s":   { en: "seconds (s)",              zh: "秒 (s)" },
  "calculator.unit.u.time.ms":  { en: "milliseconds (ms)",        zh: "毫秒 (ms)" },
  "calculator.unit.u.time.min": { en: "minutes (min)",            zh: "分钟 (min)" },
  "calculator.unit.u.time.h":   { en: "hours (h)",                zh: "小时 (h)" },
  "calculator.unit.u.time.d":   { en: "days (d)",                 zh: "天 (d)" },
  "calculator.unit.u.time.wk":  { en: "weeks (wk)",               zh: "周 (wk)" },
