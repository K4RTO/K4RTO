...
const translations: Record<string, TranslationEntry> = {
  ...
  "dock.snake":                { en: "Snake",                     zh: "贪吃蛇" },
  "snake.title":               { en: "Snake",                     zh: "贪吃蛇" },
  "snake.score":               { en: "Score",                     zh: "得分" },
  "snake.best":                { en: "Best",                      zh: "最高" },
  "snake.newGame":             { en: "New Game",                  zh: "新游戏" },
  "snake.tryAgain":            { en: "Try Again",                 zh: "再来一次" },
  "snake.gameOver":            { en: "Game Over",                 zh: "游戏结束" },
  "snake.paused":              { en: "Paused",                    zh: "暂停中" },
  "snake.pauseHint":           { en: "Press Space / P to resume", zh: "按 空格 / P 键继续" },
  "snake.hint":                { en: "Arrow keys / WASD · Space to pause",
                                 zh: "方向键 / WASD · 空格暂停" },
